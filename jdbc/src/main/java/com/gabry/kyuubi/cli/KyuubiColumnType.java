...
public enum KyuubiColumnType {
    ...
    TIMESTAMPLOCALTZ_TYPE("TIMESTAMP_WITH_LOCAL_TIME_ZONE",
    ...
    KyuubiColumnType(String name, int javaSQLType, TTypeId tType, boolean isQualified, boolean isComplex,
    ...
    KyuubiColumnType(String name, int javaSQLType, TTypeId tType, boolean isComplex, boolean isCollection) {
        this(name, javaSQLType, tType, false, isComplex, isCollection);
    }

    KyuubiColumnType(String name, int javaSqlType, TTypeId tType) {
    ...
    public static KyuubiColumnType getType(TTypeId tType) {
        for (KyuubiColumnType type : values()) {
    ...
    public static KyuubiColumnType getType(String name) {
        if (name == null) {
